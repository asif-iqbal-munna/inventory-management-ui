        ...
        <Toolbar>
          ...
          <Box sx={{ flexGrow: 1, p: 2, justifyContent: 'space-between' }}>
            <Box sx={{ display: 'flex' }}>
              ...
              <Typography sx={{ letterSpacing: 8, color: theme.palette.common.black }} variant="h6" noWrap component="div">
                Pilot
              </Typography>
            </Box>
          </Box>
          ...
          >
            <ListItem sx={{ py: 0 }} alignItems="flex-start">
              ...
              <ListItemText
                primary="Asif Iqbal Munna"
                secondary=" — Staging Admin"
